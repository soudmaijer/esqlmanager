...
{	
	// Components.
	private esql.control.ConnectionWindowCC cwcc;
	...
	public ConnectionWindowUI( esql.control.ConnectionWindowCC cwcc, ESQLManagerUI jmui )
	{	
		// Windowconstructor
		this.cwcc = cwcc;
	 ...
	 */	
	public esql.control.ConnectionWindowCC getControlClass()
	{
		return this.cwcc;
	}
	...
	public void showDatabaseTreeView( DatabaseTreeView tv )
	{
		...
		dtv.addTreeSelectionListener( new TreeSelectionListener()
		{
			...
			public void valueChanged( TreeSelectionEvent e )
			{
				...
				else if( selectedNode.getUserObject() instanceof esql.domain.TableColumn )
				{
					cwcc.fieldSelected();
				}
				// Root?!
		...
		{				
			if( e.isMetaDown() )
			{
				...
				try
				{
					...
					else if( selected instanceof esql.domain.TableColumn )
					{	
						fdlabel.setText( ((esql.domain.TableColumn)selected).getName() );
