...
{	
	...
	private esql.domain.TableColumn column;
	public boolean edit;
	public boolean add;
	...
	public FieldProperties( JFrame parent, ConnectionWindowCC cwcc, esql.domain.TableColumn column, boolean add, boolean edit )
	{	
		super(parent, true);
		this.cwcc = cwcc;
		this.db = db;
