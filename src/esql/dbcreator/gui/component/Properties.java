...
{	private Component cur;
	...
	{	if(cur != null)
		...
		if( obj instanceof esql.dbcreator.gui.model.Model )
		{
			ModelProperties mp = new ModelProperties((esql.dbcreator.gui.model.Model)obj);	
			this.setTitle("Properties for '" + ((esql.dbcreator.gui.model.Model)obj).getName() + "'");
			this.cont.add(mp);
			cur = mp;
		}		
	}
