...
public class ConnectionWindowCC extends Thread
{
	...
	public ConnectionWindowCC( ESQLManagerCC jmcc, esql.domain.ConnectionProfile cp )
	{
		this.jmcc = jmcc;
	...
	public esql.data.DatabaseConnection getDatabaseConnection() throws Exception
	{
