...
public class DatabaseTreeView extends JTree
{
   ...
   public void addDatabase( Database db )
   {
	...
	public void deleteTableColumn( nl.errorsoft.esqlmanager.domain.TableColumn tc )
	{
   	for( int i=0; i<rootNode.getChildCount();i++ )
   	{
   		DefaultMutableTreeNode node = (DefaultMutableTreeNode)rootNode.getChildAt(i);
   ...
   public void loadTableColumns( Table table, nl.errorsoft.esqlmanager.domain.TableColumn[] columns )
   {
   	for( int i=0; i<rootNode.getChildCount();i++ )
   	{
   		DefaultMutableTreeNode node = (DefaultMutableTreeNode)rootNode.getChildAt(i);
