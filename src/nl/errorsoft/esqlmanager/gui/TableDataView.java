...
public class TableDataView extends JPanel implements ActionListener
{
		...
		tbData.addMouseListener( new MouseAdapter()
		{
			public void mouseClicked( MouseEvent e )
			{
				if( e.getClickCount() == 1 )
				{
					...
					{
						nl.errorsoft.esqlmanager.domain.TableColumn tempTc = ((nl.errorsoft.esqlmanager.domain.TableColumn)(tbData.getTableHeader().getColumnModel().getColumn( tbData.getSelectedColumn() ).getHeaderValue() ) );
   ...
   public void insertNewRow()
   {
   	if( !inserting )
   	{
	   	...
	   	for( int i=0; i<cols; i++ )
	   	{
	   		...
	   		tempData.setTableColumn( (nl.errorsoft.esqlmanager.domain.TableColumn)tbData.getColumnModel().getColumn(i).getHeaderValue() );
   ...
   public void loadData( Table table, nl.errorsoft.esqlmanager.domain.TableColumn[] columns, TableData [][] tda )
   {
   	this.table = table;
   	showRecordCount();
