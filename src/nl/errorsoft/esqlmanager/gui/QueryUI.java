...
public class QueryUI extends JDialog implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			if( jcb.getSelectedItem() != null && jcb.getSelectedItem() instanceof nl.errorsoft.esqlmanager.domain.Database )
			{	cwcc.changeDatabase( (nl.errorsoft.esqlmanager.domain.Database)jcb.getSelectedItem() );
			}
