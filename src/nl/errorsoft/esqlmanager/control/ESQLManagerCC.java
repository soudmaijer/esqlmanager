...
import nl.errorsoft.dbcreator.DBCreator;
import nl.errorsoft.esqlmanager.domain.ConnectionProfile;
import nl.errorsoft.esqlmanager.domain.ESQLManager;
import nl.errorsoft.esqlmanager.domain.Registration;
import nl.errorsoft.esqlmanager.domain.ServerType;
import nl.errorsoft.esqlmanager.domain.Settings;
import nl.errorsoft.esqlmanager.gui.CheckUpdateUI;
import nl.errorsoft.esqlmanager.gui.ConnectionWindowUI;
import nl.errorsoft.esqlmanager.gui.ESQLManagerUI;
import nl.errorsoft.esqlmanager.gui.ImageLoader;
import nl.errorsoft.esqlmanager.gui.RegistrationUI;
import nl.errorsoft.esqlmanager.gui.SettingsUI;
import nl.errorsoft.esqlmanager.gui.SplashUI;
...
public class ESQLManagerCC extends java.io.OutputStream
{
	...
	public void dispatchDesigner()
	{
	   ...
	   catch( Exception e )
	   {
		...
		if( jmui.getConnectionWindowCount() > 0 )
		{
			DBCreator db = new nl.errorsoft.dbcreator.DBCreator(jmui, jmui.getConnectionWindow());
		}
	}	
