package nl.errorsoft.dbcreator.gui.model;
			...
			{				
				...
				{	Element tb = ( Element )tbs.get( i );
					...
					{	Element fd = ( Element )fds.get(j);
						...
						nl.errorsoft.esqlmanager.domain.DataType type = new nl.errorsoft.esqlmanager.domain.DataType(fd_type,false,false,false,false,false,false, false,false);
