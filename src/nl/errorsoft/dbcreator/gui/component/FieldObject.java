...
{	private String name;
	...
	public static nl.errorsoft.esqlmanager.domain.DataType [] getFieldTypes()
	{	
		nl.errorsoft.esqlmanager.domain.ServerType t = new nl.errorsoft.esqlmanager.domain.ServerType( nl.errorsoft.esqlmanager.domain.ServerType.MY_SQL );
