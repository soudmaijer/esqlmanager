...
{	// General tab
	...
	{	JPanel general = new JPanel();
		...
		nl.errorsoft.esqlmanager.domain.DataType [] fo = FieldObject.getFieldTypes();
	...
	{	if( e.getSource() == btn_new )
		{	DefaultListModel dtm = (DefaultListModel)lst_fields.getModel();
			dtm.addElement(new Field("new_field", (nl.errorsoft.esqlmanager.domain.DataType)cmb_types.getItemAt(0), "", "", ""));
		}
		...
		{	nl.errorsoft.esqlmanager.domain.DataType fo = (nl.errorsoft.esqlmanager.domain.DataType)cmb_types.getSelectedItem();
